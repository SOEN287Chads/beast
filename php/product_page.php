...
<body>
    ...
    <!-- Side Navigation Bar -->
    <div class="sidenav">
        <a href="../php/view-cart.php">VIEW CART</a>
    </div>
                                ...
                                <ul>
                                    ...
                                    ?>
                                            <li>
                                                <a href="">
                                                    <label>
                                                        <input type="checkbox" name="brand[]" value="<?php echo $row->brand_id; ?>" <?php
                            ...
                            <div class="left-sidebar-content">
                                <ul>
                                    <li>
                                        <a href="">
                                            <label>
                                                <input type="radio" name="price" value="0 to 20" <?php
                                    ...
                                    <li>
                                        <a href="">
                                            <label>
                                                <input type="radio" name="price" value="20 to 50" <?php
                                    ...
                                    <li>
                                        <a href="">
                                            <label>
                                                <input type="radio" name="price" value="50 to 100" <?php
                                    ...
                                    <li>
                                        <a href="">
                                            <label>
                                                <input type="radio" name="price" value="100 to 200" <?php
                                    ...
                                    <li>
                                        <a href="">
                                            <label>
                                                <input type="radio" name="price" value="200" <?php
                    ...
                    <div class="content mt-30">
                        ...
                        <div class="width-30">
                            ...
                            <select form="form" name="sortby">
                                ...
                                <option value="lowToHigh" <?php
                                                            if (isset($_GET['sortby']) &&  $_GET['sortby'] == "lowToHigh") {
                                                                echo "selected";
                                                            }
                                                            ?>>Price: Low to High</option>
                                <option value="highToLow" <?php
                    ...
                    ?>
                            <div class="width-33 image-box mt-30">
                                ...
                                <div class="content">
                                    ...
                                    <?php
                                    if (isset($_SESSION['email'])) {
                                        echo '<a href="addToCart.php?product_id=' . $row->product_id . '" class="btn">';
                                    } else {
                                        echo '<a href="signUp.php" class="btn">';
                                    }
                                    echo 'Add to cart
                                        </a>';
                                    ?>
